...
from hooked_layerskip import HookedLayerSkip
...
def load_hooked_transformer(
    ...
    # Check if we're loading a layerskip model.
    if "layerskip" in model_name.lower():
        tlens_model = HookedLayerSkip.from_pretrained(
            model_name,
            hf_model=hf_model,
